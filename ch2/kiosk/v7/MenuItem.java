...
public class MenuItem {//메뉴목록
    private final String[] name = {"Teriyaki Burger   ", "Shrimp Burger    ", "Hot Crispy Burger ", "Black Spice Burger","Coca Cola         ","Sprite            ", "Fanta orange      ", "Americano         ", "Cafe Latte        ","Plain Muffin      ", "Fried Potato      ", "Soft Serve        "};
    ...
    public int getNo(int a, int b) {//위치반환기 접속용
        int No;
        No = (indexer(a)[0]) + b - 1;
        return No;
    }

    public String getPrice(int a, int b) {//가격반환
    ...
    public void getBoard(int selection) {// 메뉴판
