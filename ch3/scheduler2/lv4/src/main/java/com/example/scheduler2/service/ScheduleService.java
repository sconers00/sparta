...
public class ScheduleService {
    ...
    public ScheduleResponseDto save(Member member, String title, String contents){//일정 저장
        Schedule schedule = new Schedule(member, title, contents);
    ...
    public ScheduleResponseDto findById(Long id) {//id로 일정 조회
        ...
        return new ScheduleResponseDto(findSchedule.getId(),findSchedule.getMember(),findSchedule.getTitle(), findSchedule.getContents(), findSchedule.getCreatedAt(), findSchedule.getModifiedAt());
    }
